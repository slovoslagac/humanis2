...
<div class="container container-fluid">
    <h1 class="text-center">Natkolena protetika</h1>
    <p>Natkolena proteza sastoji se od protetičkog ležišta napravljenog po meri, u kombinaciji sa podkonstrukcijom, kolenom, pilonom i stopalom.U zavisnosti od tipa proteze može se postaviti spoljna
        suspenzija u vidu remenika.</p>
    <br>
    ...
    <div class="col-md-3">
        <?php for ($i = 1; $i <= 3; $i++) { ?>
            <div class="imagesMain">
                <img src="images/nprotetika<?php echo $i ?>.jpg" class="img img-responsive center-block">
            </div>
        <?php } ?>
    </div>
